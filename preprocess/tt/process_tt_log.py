...
def parse_tt_log_timestamp(log_str):
    ...
    try:
        # Parse time string (standard format).
...
def process_tt_logs():
    print("=== Start processing TT log data (Custom Drain Config) ===")
    ...
    # Custom Drain configuration file.
    ...
    print(f"Collected {len(all_logs)} valid log lines.")
